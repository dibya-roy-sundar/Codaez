...
const { login, register, logout, changePassword, setUsername, userDetails, sendFollowRequest, acceptFollowRequest, rejectFollowRequest, updateProfile, profile } = require('../controllers/user.js');
...
router.route('/update-profile').post(catchAsync(isLoggedIn), upload.single('avatar'), catchAsync(updateProfile))
